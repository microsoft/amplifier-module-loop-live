...
candidate `e0c5b54` on v0.11.9, with voice intent, recovered-history presentation,
...
includes the v0.11.9 resource-retention hotfix and restored saved text in ordinary
canvas viewers; do not use earlier preview pins
